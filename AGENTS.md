...
- **IA Companion**: FAB com tipografia bold **abz** (não crop de LC1 em círculo — ilegível); painel aberto usa LC1 `object-contain`; motion só rings/aura; navegação fuzzy; IA real. Ver `src/lib/ia/AGENTS.md`.
