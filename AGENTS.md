...
- **IA Companion**: global em todos os módulos; STM em `localStorage` (limpa só no logout); LTM `ia_user_memory` (persiste); skills procedurais `ia_user_skills` (Hermes Agent–like, persistem); FAB pinwheel. Ver `src/lib/ia/AGENTS.md`.
