...
- `src/app/api/gestao-tripulantes/AGENTS.md` — ASO identity gate, ASO agendamento DP/logística (60d config), e-Social, Man Schedule from `gt_*`, MIO canonical pull
...
- `src/app/department/dp/AGENTS.md` — DP: MainLayout, campos achatados da lista, ASO vencimentos + agendamento (60d)
- `src/components/gestao-tripulantes/AGENTS.md` — lookups criáveis, KPIs ativos, viewport dia/semana, inbox ASO logística, scroll sticky da escala
