...
- **IA Companion**: FAB = ícone pinwheel colorido oficial (`/images/abz-icon-color.png`) flutuante (float + rotação); sem tipografia/crop LC1 no botão. Ver `src/lib/ia/AGENTS.md`.
