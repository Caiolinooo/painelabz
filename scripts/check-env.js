...
console.log('NEXT_PUBLIC_SUPABASE_URL:', ***REMOVED*** || 'Não definido');
console.log('NEXT_PUBLIC_SUPABASE_ANON_KEY:', maskValue(***REMOVED***));
console.log('***REMOVED***:', maskValue(***REMOVED***));
...
console.log('ADMIN_EMAIL:', ***REMOVED*** || 'Não definido');
console.log('ADMIN_PHONE_NUMBER:', maskValue(***REMOVED***));
console.log('ADMIN_PASSWORD:', maskValue(***REMOVED***));
