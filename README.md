...
[![Version](https://img.shields.io/badge/Version-5.43.1-orange?style=for-the-badge)](#)
...
### Inteligencia Artificial [v5.43.1]
...
- **AI Companion**: FAB com wordmark oficial ABZ (crop `LC1_Azul` + label tipografico) e aneis de status (`companion-logo-motion.ts`); IA real (tools); navegacao fuzzy com typos (`portal-navigation.ts` + `navegar_portal`)
