...
[![React](https://img.shields.io/badge/React-18.2-61DAFB?style=for-the-badge&logo=react)](https://reactjs.org/)[![Version](https://img.shields.io/badge/Version-5.71.2-orange?style=for-the-badge)](#)
...
## Novidades da Versão [v5.71.2]

| | Capacidade | Destaque |
|---|---|---|
| ✍️ | **Fechamento = quem está na lista** | USER na lista assina; ADMIN fora não fecha o ciclo. Dropdown com todos os usuários ativos. Lista vazia continua com um gestor/admin. |
