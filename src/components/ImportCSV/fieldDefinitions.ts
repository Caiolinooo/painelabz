...
export const userFieldDefinitions = {
  ...
  alternatives: {
    ...
    'phoneNumber': ['telefone', 'phone', 'phone_number', 'celular', 'mobile', 'tel', 'fone', 'Telefone Celular', 'numero_de_telefone'],
    'position': ['cargo', 'position', 'job_title', 'funcao', 'job', 'titulo'],
