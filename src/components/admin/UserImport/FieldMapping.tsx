...
const FIELD_ALTERNATIVES = {
  ...
  department: ['departamento', 'setor', 'area', 'dept', 'department', 'sector', 'business_unit'],
  position: ['cargo', 'funcao', 'job_title', 'jobTitle', 'role', 'position', 'title'],
  admissionDate: ['data_admissao', 'dataAdmissao', 'admission_date', 'admissionDate', 'hire_date', 'hireDate', 'dt_admissao'],
  registration: ['matricula', 'registration', 'employee_id', 'employeeId', 'id', 'code', 'codigo'],
  document: ['cpf', 'cnpj', 'documento', 'document', 'ssn', 'tax_id', 'taxId', 'document_number'],
  notes: ['observacoes', 'obs', 'comments', 'description', 'desc', 'notes', 'note']
};
