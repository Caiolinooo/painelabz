...
// Ícones disponíveis para reembolso removidos para dentro do componente
          ...
          <div className="max-h-60 overflow-y-auto grid grid-cols-4 gap-2">
            {filteredIcons.map(([iconName, data]) => (
              <button
                ...
                className={`p-2 rounded-md flex flex-col items-center justify-center hover:bg-gray-100 ${selectedIcon === iconName ? 'bg-blue-100 border border-blue-300' : ''
                  }`}
                title={data.label}
              >
                <div className="p-2">
            ...
            {Object.entries(customIcons).map(([iconId, url]) => (
              <button
                ...
                className={`p-2 rounded-md flex flex-col items-center justify-center hover:bg-gray-100 ${selectedIcon === iconId ? 'bg-blue-100 border border-blue-300' : ''
                  }`}
