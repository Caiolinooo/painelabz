...
export const inviteTemplate = (inviteCode: string, registerUrl: string, expiryText: string, maxUses?: number) => {
  ...
  const content = `
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${registerUrl}" class="button" style="***REMOVED*** ${config.primaryColor}; color: white; text-decoration: none; padding: 12px 24px; border-radius: 4px; font-weight: bold;">
        Registrar-se Agora
      </a>
    </div>
    <p>
