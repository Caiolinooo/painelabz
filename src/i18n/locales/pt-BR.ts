export default {
  ...
  userEditor: {
    ...
    newsDescription: 'Descrição Breve',
    newsContent: 'Conteúdo',
    category: 'Categoria',
    ...
    enabled: 'Ativado',
    thumbnail: 'Miniatura',
    thumbnailDescription: 'Imagem pequena para listagem de notícias',
    coverImage: 'Imagem de Capa',
    coverImageDescription: 'Imagem grande para página de detalhes da notícia',
    attachment: 'Anexo',
    attachmentDescription: 'Arquivo opcional para anexar à notícia',
