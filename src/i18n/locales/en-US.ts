export default {
  ...
  reimbursement: {
    ...
    policy: {
      title: 'Reimbursement Policy - ABZ Group',
      introduction: 'This document establishes the guidelines and procedures for requesting and processing reimbursements of expenses related to the professional activities of ABZ Group employees.',
      eligibility: '1. Eligibility',
      eligibilityText: 'Expenses directly related to professional activities, previously authorized by the responsible manager, and that comply with company policies are eligible for reimbursement.',
      typesTitle: '2. Types of Reimbursable Expenses',
      foodLabel: 'Food:',
      foodText: 'Meals during business trips or external meetings.',
      transportLabel: 'Transportation:',
      transportText: 'Service travel, including taxi, transport apps, fuel, tolls, and parking.',
      accommodationLabel: 'Accommodation:',
      accommodationText: 'Hotel stays during business trips.',
      materialsLabel: 'Work Materials:',
      materialsText: 'Items necessary for performing professional activities.',
      otherLabel: 'Other expenses:',
      otherText: 'Subject to prior approval by the manager.',
      documentationTitle: '3. Required Documentation',
      documentationText: 'For all reimbursement requests, it is mandatory to present valid tax receipts (invoices, tax receipts, receipts) that contain:',
      docDate: 'Date and time of expense',
      docAmount: 'Amount',
      docDescription: 'Description of product or service',
      docSupplier: 'Supplier identification (CNPJ or CPF)',
      deadlinesTitle: '4. Deadlines',
      deadlinesText: 'Reimbursement requests must be submitted within 30 days after the expense is incurred. Processing will be carried out within 10 business days after manager approval.',
      paymentTitle: '5. Payment Methods',
      paymentText: 'Reimbursement will preferably be made by:',
      paymentBank: 'Deposit to employee\'s bank account',
      paymentPix: 'PIX transfer',
      paymentCash: 'In exceptional cases, cash payment by the financial agent',
      restrictionsTitle: '6. Restrictions',
      restrictionsText: 'Expenses will not be reimbursed if:',
      restrictionProof: 'Without adequate fiscal proof',
      restrictionPersonal: 'Of a personal nature',
      restrictionAuth: 'Not previously authorized (when applicable)',
      restrictionPolicy: 'In disagreement with company policies',
      restrictionDoc: 'With illegible or incomplete documentation',
      finalTitle: '7. Final Considerations',
      finalText: 'ABZ Group reserves the right to audit reimbursement requests at any time. Omitted cases will be analyzed by the Financial Board. This policy may be reviewed and updated periodically.',
