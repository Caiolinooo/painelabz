export default {
  ...
  viewer: {
    ...
    openedInNewTab: 'The document has been opened in a new tab.',
    translatedDocument: 'Translated document available for your language.',
    noTranslation: 'This document is only available in Portuguese.',
    originalDocument: 'Original document in Portuguese.',
    checkingTranslations: 'Checking available translations...',
    errorRendering: 'Error rendering document',
    downloadInstead: 'Download document'
  },
  reimbursement: {
    title: 'Reimbursement',
