          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Configure perfis de cálculo para diferentes tipos de funcionários
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-500 mb-6">
            Esta funcionalidade está em desenvolvimento. Em breve você poderá configurar perfis de cálculo personalizados para diferentes categorias de funcionários.
          </p>
          <Link
            href="/folha-pagamento"
