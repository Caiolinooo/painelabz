...
export async function GET(request: NextRequest) {
  try {
    ...
    if (error) {
      console.error('Erro ao listar Tabela 50:', error);
      return NextResponse.json({ error: 'Erro ao listar Tabela 50' }, { status: 500 });
    }
    ...
    console.error('Erro em GET /api/e-social/tabela-50:', error);
