  ...
  useEffect(() => {
    const checkEvaluationManager = async () => {
      try {
        ...
        // Usar fetchWithToken para garantir que o token seja enviado corretamente
        // e lidar com renovação/expiração se necessário
        const response = await fetchWithToken(`/api/avaliacao/is-manager`, {
          method: 'GET',
        });
