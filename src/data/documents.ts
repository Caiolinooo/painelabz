...
export const procedimentosLogistica: Document[] = [
  {
    id: 'proc-log-1',
    title: 'Procedimento de Logística (Revisado)',
    description: 'Documento com os procedimentos operacionais revisados para a área de logística.',
    category: 'Logística',
    language: 'Português',
...
export const procedimentosGerais: Document[] = [
  {
    ...
    category: 'Compras',
    language: 'Português',
    file: '/documentos/procedimentos/e-mail_sobre_ponto.pdf',
    enabled: true,
    order: 1,
    createdAt: '2024-01-01',
    updatedAt: '2024-01-01'
