...
export const procedimentosLogistica: Document[] = [
  {
    ...
    category: 'Logística',
    language: 'Português',
    file: '/documentos/procedimentos/logistica/recebimento.pdf',
    enabled: true,
    order: 1,
    createdAt: '2024-01-01',
    updatedAt: '2024-01-01'
  },
  {
    ...
    category: 'Logística',
    language: 'Português',
    file: '/documentos/procedimentos/logistica/expedicao.pdf',
    enabled: true,
    order: 2,
    createdAt: '2024-01-01',
    updatedAt: '2024-01-01'
...
export const procedimentosGerais: Document[] = [
  {
    ...
    category: 'Compras',
    language: 'Português',
    file: '/documentos/procedimentos/gerais/compras.pdf',
    enabled: true,
    order: 1,
    createdAt: '2024-01-01',
    updatedAt: '2024-01-01'
  },
  {
    ...
    category: 'RH',
    language: 'Português',
    file: '/documentos/procedimentos/gerais/rh.pdf',
    enabled: true,
    order: 2,
    createdAt: '2024-01-01',
    updatedAt: '2024-01-01'
