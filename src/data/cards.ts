...
export function getTranslatedCards(t: (key: string) => string): DashboardCard[] {
  return [
    ...
    },
    {
      ...
      description: t('cards.academyDesc'),
      href: '/academy',
      icon: FiPlay,
      iconName: 'FiPlay',
      color: 'bg-blue-600',
    ...
    {
      id: 'social',
      title: t('cards.social'),
      description: t('cards.socialDesc'),
      href: '/social',
      icon: FiUsers,
      iconName: 'FiUsers',
      color: 'bg-purple-600',
    ...
    },
    {
      ...
      title: t('cards.avaliacoesAvancadas'),
      description: t('cards.avaliacoesAvancadasDesc'),
    ...
    {
      id: 'relatorios-pdf',
      title: t('cards.relatoriosPdf'),
      description: t('cards.relatoriosPdfDesc'),
      href: '/relatorios-pdf',
      icon: FiDownload,
      iconName: 'FiDownload',
      color: 'bg-purple-600',
    ...
    {
      id: 'api-mobile',
      title: t('api_mobile.titulo'),
      description: t('api_mobile.descricao'),
      href: '/api-mobile',
      icon: FiSmartphone,
    ...
    {
      id: 'integracao-erp',
      title: t('erp_integration.titulo'),
      description: t('erp_integration.descricao'),
      href: '/integracao-erp',
      icon: FiDatabase,
      iconName: 'FiDatabase',
      color: 'bg-purple-600',
    ...
    {
      id: 'dashboard-bi',
      title: t('dashboard_bi.titulo'),
      description: t('dashboard_bi.descricao'),
      href: '/dashboard-bi',
      icon: FiBarChart,
      iconName: 'FiBarChart',
    ...
    {
      id: 'workflows',
      title: t('workflows.titulo'),
      description: t('workflows.descricao'),
      href: '/workflows',
      icon: FiGitBranch,
